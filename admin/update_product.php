...
if(isset($_POST['update'])){
   ...
   $update_product->execute([$name, $category, $price, $pid, $des]);
...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="enter product description" name="des" maxlength="50"class="box" value="<?= $fetch_products['des']; ?>">
